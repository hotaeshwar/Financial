...
export default function ReceiptModal({ isOpen, onClose, item, type }) {
  ...
  const drawReceiptOnCanvas = (ctx, logoImg) => {
    ...
    ctx.fillText("BiD Finance Monitor", 300, 165);
    ...
    ctx.fillText("Thank you for using BiD Finance Monitor", 300, 685);
      ...
      <html>
        ...
        <body>
          <div class="receipt">
            ...
            <div class="title">BiD Finance Monitor</div>
            ...
            <div class="footer">
              Thank you for using BiD Finance Monitor<br/>
        ...
        <div className="p-6 overflow-y-auto max-h-[60vh] flex-1 bg-slate-50/50">
          <div className="bg-white border border-slate-200/80 rounded-xl p-5 shadow-sm space-y-5 relative overflow-hidden">
            ...
            <div className="flex flex-col items-center text-center space-y-2">
              ...
              />
              <div>
                <h5 className="font-bold text-slate-800 text-base">BiD Finance Monitor</h5>
            ...
            <p className="text-[9px] text-slate-400 text-center leading-relaxed">
              This receipt is automatically generated by the BiD Finance Monitor platform.<br />
